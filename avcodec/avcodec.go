...
func (cp *AvCodecParameters) AvCodecParametersToContext(context *Context) int {
	return int(C.avcodec_parameters_to_context((*C.struct_AVCodecContext)(context), (*C.struct_AVCodecParameters)(cp)))
}
